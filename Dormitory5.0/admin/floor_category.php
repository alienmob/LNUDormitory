...
<title>LNU Dormitory | Floor Category</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper bg-gradient-default">
    ...
    <section class="content-header text-white">
      ...
      <ol class="breadcrumb bg-default">
        ...
        <li>Facility</li>
        <li class="active text-white">Floor Category</li>
      </ol>
    </section>
    <!-- Main content -->
  ...
  <?php include 'includes/floor_category_modal.php'; ?>
</div>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'floor_category_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.catid').val(response.id);
      $('#edit_name').val(response.floor_name);
      $('#del_cat').html(response.floor_name);
    }
  });
}
</script>
